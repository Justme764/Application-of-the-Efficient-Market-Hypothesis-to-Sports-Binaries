...
from NBAVegasInsiderCrawler import NBAVegasInsiderCrawler
...
NBA_CSV_FILENAME = 'NBA Vegas Data.csv'

NBA_KS_FILENAME = 'NBA Vegas KS.csv'

NBA_EV_FILENAME = 'NBA Vegas EV.csv'

NBA_FINAL_CSV = 'NBA Final.csv'

t_0 = time()


csv_matrix = []  # initialize the matrix
with open(NBA_EV_FILENAME, "r") as csv_file:  # open the file
...
for t in threshold:
    ...
    for row_idx in range(2, len(csv_matrix), 3):
        ...
        # if fav_win_pct < (0.5 - eps/100) or fav_win_pct > (0.5 + eps/100):
        #     edge += 1
        #     total_bet_on += 1
